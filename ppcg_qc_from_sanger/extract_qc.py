...
OUTPUT_HEADER = [
    ...
    'Tumour median fraction of mapped reads',
    'Tumour insert size per RG',
    'Tumour median Insert size',
    'Tumour insert size sd per RG',
    'Tumour median insert size sd',
    'Tumour r1 GC content per RG',
    'Tumour median r1 GC content',
    'Tumour r2 GC content per RG',
    'Tumour median r2 GC content',
    'Tumour fraction of duplicated reads per RG',
    'Tumour median fraction of duplicated reads',
    'Tumour fraction of mis-matched pairs per RG',
    'Tumour median fraction of mis-matched pairs',
    'Tumour contamination per RG',
    'Tumour median contamination',
    'Tumour sex',
    ...
    'Normal median fraction of mapped reads',
    'Normal insert size per RG',
    'Normal median Insert size',
    'Normal insert size sd per RG',
    'Normal median insert size sd',
    'Normal r1 GC content per RG',
    'Normal median r1 GC content',
    'Normal r2 GC content per RG',
    'Normal median r2 GC content',
    'Normal fraction of duplicated reads per RG',
    'Normal median fraction of duplicated reads',
    'Normal fraction of mis-matched pairs per RG',
    'Normal median fraction of mis-matched pairs',
    'Normal contamination per RG',
    'Normal median contamination',
    'Donor ID',
    'Donor UUID']

VARIANT_COUNT_HEADER = [
    'Number of SNVs (PASS/All)', 'SNVs per Chr (chromosome:[PASS, ALL])',
    'Number of INDELs (PASS/All)', 'INDELs per Chr (chromosome:[PASS, ALL])',
    'Number of SVs (PASS/All)', 'SVs per Chr (chromosome:[PASS, ALL])',
    'Number of CNVs'
]
